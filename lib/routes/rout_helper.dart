...
import 'package:delevery_app/pages/location/add_location_page.dart';
import 'package:get/get.dart';

import '../pages/Food/popular_food_detail.dart';
import '../pages/Food/recommended_food_detail.dart';
import '../pages/Home/home_page.dart';
import '../pages/location/pick_address_map.dart';
...
class RouteHelper {
  ...
  static const String pickAddressMap = "/pick-map";
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: addAddressPage, page: ()=>AddAddressPage(),transition: Transition.fadeIn),
